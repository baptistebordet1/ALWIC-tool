            ...
            try :
                for i in range(0,len(list_files)):
                    ...
                    if self.option_protocol.get() == "van_Geldern_mode":
                        ...
                        self.final_value_file_df,self.calibration_param_list,self.calibration_vectors=cal.wrapper_calibration(self.corrected_file_df, self.iso_type_list, self.std_idx_norm, self.std_values, self.inj_per_std, self.result_file_df, self.removed_inj_per_std,self.std_nbr,self.protocol_type,self.MCs)
...
class evaluate_parameters_page():
    ...
    def processing_eval_groning(self):
        ...
        self.final_value_file_df,self.calibration_param_list,self.calibration_vectors=cal.wrapper_calibration(self.corrected_file_df, self.main_window.iso_type_list, self.main_window.std_idx_norm, self.main_window.std_values, self.main_window.inj_per_std, self.main_window.result_file_df, self.main_window.removed_inj_per_std,self.main_window.std_nbr,self.protocol_type,self.main_window.MCs)
